...
<div class="flex items-center justify-center h-screen bg-transparent relative" style="transform: translate({0}px,{$inputUp-10}px)">

	<div class="relative w-10/12 sm:w-2/3 md:w-1/2 lg:w-1/3 z-30 flex flex-col items-center">

		<!-- This is your new title -->
		<div style="font-family: {gennedFont}" class="text-[100px] font-bold mb-[55px] text-center w-full">
			paletteBot
		</div>
		{#if $inputUp}
		<div class="text-[20px] font-bold mb-[20px] text-center w-full">
			{#if $totalGenerations>0}
				{gennedFont}
				{:else}
				&nbsp;
